...
import Section09Canvas, { Section09CanvasRef } from "./Section09Canvas";

export default function Section09MakeItYours() {
  const containerRef = useRef<HTMLDivElement>(null);
  const canvasRef = useRef<Section09CanvasRef>(null);
  ...
  return (
    <section
      ...
      aria-label="Section 09 — Start With a Template. Make It Yours."
    >
