...
import Section05Canvas, { Section05CanvasRef } from "./Section05Canvas";

export default function Section05DesignedFromSections() {
  const containerRef = useRef<HTMLDivElement>(null);
  const canvasRef = useRef<Section05CanvasRef>(null);
  ...
  return (
    <section
      ...
      aria-label="Section 05 — Designed From Sections."
    >
