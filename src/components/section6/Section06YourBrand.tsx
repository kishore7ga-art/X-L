...
import Section06Canvas, { Section06CanvasRef } from "./Section06Canvas";

export default function Section06YourBrand() {
  const containerRef = useRef<HTMLDivElement>(null);
  const canvasRef = useRef<Section06CanvasRef>(null);
  ...
  return (
    <section
      ...
      aria-label="Section 06 — Your Brand. Your Identity."
    >
