...
import Section01Canvas, { Section01CanvasRef } from "./Section01Canvas";

export default function Section01WhatIsXite() {
  const containerRef = useRef<HTMLDivElement>(null);
  const canvasRef = useRef<Section01CanvasRef>(null);
  ...
  return (
    <section
      ...
      aria-label="Section 01 — What Is Xite"
    >
