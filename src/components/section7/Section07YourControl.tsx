...
import Section07Canvas, { Section07CanvasRef } from "./Section07Canvas";

export default function Section07YourControl() {
  const containerRef = useRef<HTMLDivElement>(null);
  const canvasRef = useRef<Section07CanvasRef>(null);
  ...
  return (
    <section
      ...
      aria-label="Section 07 — Your Website. Your Control."
    >
