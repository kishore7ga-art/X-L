...
import Section04Canvas, { Section04CanvasRef } from "./Section04Canvas";

export default function Section04YourPages() {
  const containerRef = useRef<HTMLDivElement>(null);
  const canvasRef = useRef<Section04CanvasRef>(null);
  ...
  return (
    <section
      ...
      aria-label="Section 04 — Your Institution. Your Pages."
    >
