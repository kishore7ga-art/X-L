...
import Section03Canvas, { Section03CanvasRef } from "./Section03Canvas";

export default function Section03EveryScreen() {
  const containerRef = useRef<HTMLDivElement>(null);
  const canvasRef = useRef<Section03CanvasRef>(null);
  ...
  return (
    <section
      ...
      aria-label="Section 03 — One Website. Every Screen."
    >
