...
import Section13Canvas, { Section13CanvasRef } from "./Section13Canvas";

export default function Section13BuildWhatComesNext() {
  const containerRef = useRef<HTMLDivElement>(null);
  const canvasRef = useRef<Section13CanvasRef>(null);
  ...
  return (
    <section
      ...
      aria-label="Section 13 — Build What Comes Next."
    >
